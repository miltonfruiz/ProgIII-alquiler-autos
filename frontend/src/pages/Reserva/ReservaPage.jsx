...
function ReservaPage() {
  ...
  // Recibe el auto desde el state de navegación: navigate("/reserva", { state: { auto } })
      ...
      <div className={styles.pageWrapper}>
            ...
            <form onSubmit={handleSubmit}>
              <div className={styles.inputConteiner}>
                ...
                <div className={styles.errorContainer}>
                  <p
                    className={`${styles.errorMessage} ${errores.hora_inicio ? styles.visible : ""}`}
                  >
                    {errores.hora_inicio}
                  </p>
                </div>
                <div className={styles.errorContainer}>
                  <p
                    className={`${styles.errorMessage} ${errores.fecha_inicio ? styles.visible : ""}`}
                  >
                ...
                <div className={styles.errorContainer}>
                  <p
                    className={`${styles.errorMessage} ${errores.hora_fin ? styles.visible : ""}`}
                  >
                    {errores.hora_fin}
                  </p>
                </div>
                <div className={styles.errorContainer}>
                  <p
                    className={`${styles.errorMessage} ${errores.fecha_fin ? styles.visible : ""}`}
                  >
                    {errores.fecha_fin}
                  </p>
                </div>
          ...
          <div className={styles.rightPanel}>
            ...
            <div className={styles.placeInfo}>
              ...
              <div className={styles.mapContainer}>
                <MapComponent location={formData.lugar_retiro} height="180px" />
              </div>
            ...
            <div className={styles.placeInfo}>
              ...
              <div className={styles.dropdownContainer}>
                ...
                <div className={styles.customSelect}>
                  ...
                  >
                    <option value="">Selecciona un lugar de devolución</option>
                ...
                <div className={styles.errorContainer}>
                  <p
                    className={`${styles.errorMessage} ${errores.lugar_devolucion ? styles.visible : ""}`}
                  >
        ...
        <footer className={styles.pageFooter}>
          <div className={styles.footerPricing}>
            <span className={styles.footerImpuestos}>
              Impuestos: $
              {impuestos.toLocaleString("es-AR", { maximumFractionDigits: 2 })}{" "}
              Ars
            </span>
