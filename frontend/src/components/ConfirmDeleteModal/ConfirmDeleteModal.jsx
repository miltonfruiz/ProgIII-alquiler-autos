...
const ConfirmDeleteModal = ({ carName, onConfirm, onCancel }) => {
  return (
    <div className="modal-overlay-cars">
      <div className="modal-content-cars confirm-delete">
        <h3 className="confirm-title">
          <IoWarning className="warning-modal-icon" /> ¿Desea eliminar el auto "
          {carName}"? <IoWarning className="warning-modal-icon" />
        </h3>
